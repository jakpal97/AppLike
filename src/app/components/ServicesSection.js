...
const services = [
  { id: "01", title: "Strony WWW", desc: "Responsywne strony internetowe, które wyróżniają Twoją markę i przekonują odwiedzających do działania." },
  { id: "02", title: "Aplikacje Web", desc: "Dedykowane rozwiązania webowe z panelami administracyjnymi i integracjami dopasowanymi do Twojego biznesu." },
  { id: "03", title: "Aplikacje Mobile", desc: "Natywne i hybrydowe aplikacje mobilne zapewniające płynne doświadczenia na wszystkich urządzeniach." },
  { id: "04", title: "Ads & SEO", desc: "Kompleksowe kampanie reklamowe i optymalizacja SEO zwiększające widoczność i konwersje Twojej firmy." },
];
      ...
      <div className="relative w-full h-screen flex items-center justify-center px-4 lg:px-20 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-12 gap-12 w-full max-w-[1500px] items-center">
          ...
          <div className="w-full lg:col-span-5 z-20 order-2 lg:order-1 text-center lg:text-left">
            ...
            <div className="min-h-[300px] flex flex-col justify-center">
              <h3 key={`title-${activeIndex}`} className="animate-in-text text-[10vw] lg:text-[5vw] font-black text-black leading-[0.9] tracking-tighter uppercase mb-6">
                {services[activeIndex].title}
              </h3>
              
              <p key={`desc-${activeIndex}`} className="animate-in-text text-base lg:text-xl text-black/60 max-w-md mx-auto lg:mx-0 leading-relaxed font-medium mb-10">
        ...
        <div className="absolute right-10 hidden lg:flex flex-col gap-4">
          {services.map((_, i) => (
            <div 
              key={i}
              className="relative w-1 h-12 bg-zinc-100 overflow-hidden rounded-full"
            >
              <div 
