	...
	return (
		<section ref={sectionRef} id="o-mnie" className="relative h-screen w-full overflow-hidden bg-white">
			...
			<div className="photo-bg absolute inset-0">
				<Image src="/jakub.jpg" alt="Jakub" fill className="object-cover object-top" priority />
			</div>
			...
			<div
				...
				style={{
					background:
						'linear-gradient(to right, rgba(255,255,255,0.55) 0%, transparent 45%, rgba(255,255,255,0.4) 100%)',
				}}
			/>
